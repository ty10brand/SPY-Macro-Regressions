...
macro_path = os.path.join(base_dir, "data/macro_individual_csvs/GDP.csv")  # <-- GDP here
plot_output = os.path.join(base_dir, "charts/regression_SPY_vs_GDP.png")
csv_output = os.path.join(base_dir, "data/regression_output_SPY_vs_GDP.csv")
...
plt.title("Linear Regression: SPY Returns vs GDP")
plt.grid(True)
plt.legend()
plt.tight_layout()
...
summary_output_path = os.path.join(base_dir, "data/regression_summary_SPY_vs_GDP.txt")
