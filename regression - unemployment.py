...
csv_output = os.path.join(base_dir, "data/regression_output_SPY_vs_Unemployment.csv")
...
# === LOAD MACRO VARIABLE (Unemployment) ===
...
plt.title("Linear Regression: SPY Returns vs Unemployment Rate")
plt.grid(True)
plt.legend()
plt.tight_layout()
...
summary_output_path = os.path.join(base_dir, "data/regression_summary_SPY_vs_Unemployment.txt")
