...
macro_path = os.path.join(base_dir, "data/macro_individual_csvs/CPI.csv")  # <-- CPI here
plot_output = os.path.join(base_dir, "charts/regression_SPY_vs_CPI.png")
csv_output = os.path.join(base_dir, "data/regression_output_SPY_vs_CPI.csv")
...
plt.title("Linear Regression: SPY Returns vs CPI")
plt.grid(True)
plt.legend()
plt.tight_layout()
...
summary_output_path = os.path.join(base_dir, "data/regression_summary_SPY_vs_CPI.txt")
