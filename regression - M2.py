...
macro_path = os.path.join(base_dir, "data/macro_individual_csvs/M2_Money_Supply.csv")  # <-- M2 here
plot_output = os.path.join(base_dir, "charts/regression_SPY_vs_M2.png")
csv_output = os.path.join(base_dir, "data/regression_output_SPY_vs_M2.csv")
...
plt.title("Linear Regression: SPY Returns vs M2 Money Supply")
plt.grid(True)
plt.legend()
plt.tight_layout()
...
summary_output_path = os.path.join(base_dir, "data/regression_summary_SPY_vs_M2.txt")
