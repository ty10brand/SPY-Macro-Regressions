...
macro_path = os.path.join(base_dir, "data/macro_individual_csvs/Consumer_Sentiment.csv")  # <-- Updated
plot_output = os.path.join(base_dir, "charts/regression_SPY_vs_ConsumerSentiment.png")    # <-- Updated
csv_output = os.path.join(base_dir, "data/regression_output_SPY_vs_ConsumerSentiment.csv")# <-- Updated
...
plt.title("Linear Regression: SPY Returns vs Consumer Sentiment")
plt.grid(True)
plt.legend()
plt.tight_layout()
...
summary_output_path = os.path.join(base_dir, "data/regression_summary_SPY_vs_ConsumerSentiment.txt")  # <-- Updated
